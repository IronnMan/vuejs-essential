      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body" data-validator-form>
          ...
          <div class="form-group">
            ...
            <input type="password" id="password" class="form-control" placeholder="请填写密码" v-model.trim="password" v-validator:input.required="{ regex: /^\w{6,16}$/, error: '密码要求 6 ~ 16 个单词字符' }">
          </div>
          <div class="form-group">
            <label class="control-label">确认密码</label>
            <input type="password" class="form-control" placeholder="请填写确认密码" v-model.trim="cpassword" v-validator:input.required="{ target: '#password' }">
          </div>
          <div class="form-group">
            <label class="control-label">图片验证码</label>
            <input type="text" class="form-control" placeholder="请填写验证码" v-model.trim="captcha" v-validator:input.required="{ title: '图片验证码' }">
          </div>
